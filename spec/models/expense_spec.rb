...
RSpec.describe Expense, type: :model do
  ...
  describe "Expense" do
    ...
    context "#admin_approval_method" do
    ...
    context "#approve expense" do
      it "should decrease budget amount by approving" do
    ...
    context "#valid budget year and month not exist" do
